...
public class TextureRefRendererFeature : ScriptableRendererFeature
{
    ...
    class UpdateRefPass : ScriptableRenderPass
    {
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            foreach (var mat in m_DisplayMaterials)
            {
                ...
                using (var builder = renderGraph.AddRasterRenderPass<PassData>($"UpdateRefPass_{mat.name}", out var passData))
                {
                    ...
                    //     texRef.texture = resourceData.cameraColor;
                    // }
                    ...
                    // passData.destination = UniversalRenderer.CreateRenderGraphTexture(renderGraph, desc, "_InputTexture", false);
                    
                    RenderTextureDescriptor textureProperties = new RenderTextureDescriptor(Screen.width, Screen.height, RenderTextureFormat.Default, 0);

                    // Create the texture
                    TextureHandle targetTexture = UniversalRenderer.CreateRenderGraphTexture(renderGraph, textureProperties, "_InputTexture3", false);
                    ...
                    // builder.SetGlobalTextureAfterPass(passData.destination, Shader.PropertyToID("_InputTexture"));
                }
            }
        }
        ...
        static void ExecutePass(PassData data, RasterGraphContext rgContext)
        {
            ...
            Blitter.BlitTexture(rgContext.cmd, data.source,
